...
if __name__ == "__main__":
    ...
    # training dataloader
    chess_train_dataset = PGNDatabase(path_csv_database="/home/ditu/Documents/03_Projects/01_ChessEngine/database"
                                                        "/chess_train_database.csv")
    dataloader_train = DataLoader(chess_train_dataset,
                                  batch_size=300, shuffle=True,
                                  num_workers=1, drop_last=True)
    # validation dataloader
    chess_val_dataset = PGNDatabase(path_csv_database="/home/ditu/Documents/03_Projects/01_ChessEngine/database"
